...
const usuarios = [
  { email: "admin@libreria.com", nombre: "Admin", password: "Admin1234", rol: "ADMIN" as const },
  { email: "cliente@libreria.com", nombre: "Cliente Uno", password: "Cliente1234", rol: "CLIENTE" as const },
];
